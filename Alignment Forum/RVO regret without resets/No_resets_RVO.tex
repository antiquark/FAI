...
The above is essentially what appeared as "Proposition B.1" [before](https://agentfoundations.org/item?id=1723), for the special case of PSRL, and where we regard every episode as a single time step in a new MDP where every action is a policy for the duration of an episode in the original MDP.
...
$$\Ea{}{\V_{l}\AP{\Theta_{lT}}-\V_{l0}\AP{\Theta_{lT}}}=\sum_{n=lT}^{lT+k-1}\gamma^{n-lT}\Ea{}{\Ea{\SHy_n\AP{\Theta_n,\AT_n}-\THy\AP{\Theta_n,\AT_n}}{\V_{l}}}+\gamma^k\Ea{}{\V_{l}\AP{\Theta_{lT+k}}-\V_{lk}\AP{\Theta_{lT+k}}}$$

For $k=0$ this is a tautology. For any $k\in[T]$, the Bellman equation says that

$$\V_l(s)=(1-\gamma)\R(s)+\gamma\Ea{\SHy_{lT}\Pi\AP{\SHy_{lT}}(s)}{\V_l}$$

$$\V_{lk}(s)=(1-\gamma)\R(s)+\gamma\Ea{\SHy_{*}\Pi\AP{\SHy_{lT}}(s)}{\V_{l,k+1}}$$

It follows that

$$\Ea{}{\V_{l}\AP{\Theta_{lT+k}}-\V_{lk}\AP{\Theta_{lT+k}}}=\gamma\Ea{}{\Ea{\SHy_{lT}\Pi\AP{\SHy_{lT}}\AP{\Theta_{lT+k}}}{\V_l}-\Ea{\SHy_{*}\Pi\AP{\SHy_{lT}}\AP{\Theta_{lT+k}}}{\V_{l,k+1}}}$$

Since $\Pi\AP{\SHy_{lT}}$ is exactly the policy followed by PSRL at time $lT+k$, we get

$$\Ea{}{\V_{l}\AP{\Theta_{lT+k}}-\V_{lk}\AP{\Theta_{lT+k}}}=\gamma\Ea{}{\Ea{\SHy_{lT}\AP{\Theta_{lT+k},\AT_{lT+k}}}{\V_l}-\Ea{\SHy_{*}\AP{\Theta_{lT+k},\AT_{lT+k}}}{\V_{l,k+1}}}$$

$$\Ea{}{\V_{l}\AP{\Theta_{lT+k}}-\V_{lk}\AP{\Theta_{lT+k}}}=\gamma\AP{\Ea{}{\Ea{\SHy_{lT}\AP{\Theta_{lT+k},\AT_{lT+k}}-\SHy_{*}\AP{\Theta_{lT+k},\AT_{lT+k}}}{\V_l}}+\Ea{}{\V_l\AP{\Theta_{lT+k+1}}-\V_{l,k+1}\AP{\Theta_{lT+k+1}}}}$$
