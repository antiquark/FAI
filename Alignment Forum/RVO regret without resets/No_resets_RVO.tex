...
% Two steps after Proposition B.N2:
% From identity matrix to arbitrary form
% From finite sum to discounted sum (use Laplace transform)
...
We will now assume $\gamma^T>\frac{1}{2}$. Applying Proposition A.N3, we conclude
