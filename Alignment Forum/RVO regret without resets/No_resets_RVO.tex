...
% Add corresponding theorems to Appendix
...
% Is the infimum attained by a specific projection operator?
% At least for finite-dimensional \Y?
% In the finite-dimensional case the space of operators of norm \leq M is compact
% The condition P^2 = P is closed
% The condition Im P = \Z is not closed inside the space of all operators, however
% The condition Im P = \Z *is* closed inside the space of projection operators
% So the answer is yes!
% (In fact, the projection operators to \Z form an affine space)
