...
$$\Ea{y\sim\iota_*\mu}{\exp\AP{\Chev{\lambda,\ y-\mu}}} \leq \exp\AP{\frac{\sigma^2\Norm{\lambda}^2}{2}}$$
...
??? Does CS make sense here? We only defined it below! Also, tweak the other propositions to better accommodate the form of delta! ???
