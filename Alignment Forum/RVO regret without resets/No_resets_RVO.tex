...
That is, $\Pi_n\AP{\T_1,\T_2}$ is a policy that follows $\Pi\AP{\T_1}$ for time $n$ and $\Pi\AP{\T_2}$ afterwards. It is easy to see that

$$\Reg(\gamma)=\sum_{l=0}^\infty{\gamma^{lT}\Ea{}{\V_{\SHy_*\R}\AP{\Theta_{lT},\gamma}-\V_{\SHy_*\Pi_T\AP{\SHy_{lT},\SHy_*}\R}\AP{\Theta_{lT},\gamma}}}$$
...
In the following, we will drop $\R$ in the subscripts and $\gamma$ in the arguments of $\V$, and denote $\pi_{kl}:=\Pi_k\AP{\SHy_{lT},\SHy_*}$.

By definition, $\SHy_{lT}$ and $\SHy_*$ have the same distribution even when conditioned by the history up to $lT$. Therefore

$$\Ea{}{\V_{\SHy_*}\AP{\Theta_{lT}}}=\Ea{}{\V_{\SHy_{lT}}\AP{\Theta_{lT}}}$$

It follows that

$$\Reg(\gamma)=\sum_{l=0}^\infty{\gamma^{lT}\Ea{}{\V_{\SHy_{lT}}\AP{\Theta_{lT}}-\V_{\SHy_*\pi_{Tl}}\AP{\Theta_{lT}}}}$$

We now prove by induction on $k\in[T+1]$ that

$$\Ea{}{\V_{\SHy_{lT}}\AP{\Theta_{lT}}-\V_{\SHy_*\pi_{Tl}}\AP{\Theta_{lT}}}=\sum_{n=lT}^{lT+k-1}\gamma^{n-lT}\Ea{}{\Ea{\SHy_n\AP{\Theta_n,\AT_n}-\THy\AP{\Theta_n,\AT_n}}{\V_{\SHy_n}}}+\gamma^k\Ea{}{\V_{\SHy_{lT}}\AP{\Theta_{lT+k}}-\V_{\SHy_*\pi_{T-k,l}}\AP{\Theta_{lT+k}}}$$
