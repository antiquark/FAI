...
$$+(1-\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\IT_k}^{\ET_{k+1}-1}\gamma^n\CE{\Ev_{**}^{n-\IT_k}-\Ev_{*k}^{n-\IT_k}}{\R_*}{\Theta_{\IT_k}}}$$
...
$$\Pa{}{K_{n}\leq {\frac{n}{2T}}-1}\leq\exp\AP{\frac{1}{2}-\frac{n}{4T}}$$
...
$$\Pa{}{M_k\geq (k+1)T+m-1}\leq\exp\AP{-\frac{2m^2}{(k+1)\AP{2T-2}^2}}$$

Taking $m:=(k+1)T$, we get

$$\Pa{}{M_k\geq 2(k+1)T}\leq\exp\AP{-\frac{2(k+1)^2T^2}{4(k+1)\AP{T-1}^2}}\leq\exp\AP{-\frac{k+1}{2}}$$

Moreover, by definition of $K_n$, we have, for any $k,n\in\Nats$

$$\Pa{}{K_n\leq k}=\Pa{}{M_k\geq n}$$

It follows that

$$\Pa{}{K_{2(k+1)T}\leq k}=\Pa{}{M_k\geq 2(k+1)T}\leq\exp\AP{-\frac{k+1}{2}}$$

Note that the above trivially holds for $k=-1$ as well. Consider any $n\in\Nats$ and take $k:=\Floor{\frac{n}{2T}}-1$. We get

$$\Pa{}{K_{2\Floor{\frac{n}{2T}}T}\leq \Floor{\frac{n}{2T}}-1}\leq\exp\AP{-\frac{1}{2}\Floor{\frac{n}{2T}}}\leq\exp\AP{-\frac{1}{2}\AP{\frac{n}{2T}-1}}$$

$$\Pa{}{K_{n}\leq {\frac{n}{2T}}-1}\leq\exp\AP{\frac{1}{2}-\frac{n}{4T}}\ \blacksquare$$
...
$$\sum_{n=0}^\infty\gamma^{\frac{n}{2T}-1}\Ea{}{f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}}\leq 2CT+\frac{\sqrt{e}}{1-\exp\AP{-\frac{1}{4T}}}$$
...
$$\sum_{n=0}^\infty\Ea{}{\frac{1}{2T}\gamma^{K_n}f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}} \leq C$$

$$\sum_{n=0}^\infty\Ea{}{\gamma^{K_n}f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}} \leq 2CT$$

Using Proposition A.14, we get

$$\sum_{n=0}^\infty\AP{\Ea{}{\gamma^{\frac{n}{2T}-1}f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}}-\exp\AP{\frac{1}{2}-\frac{n}{4T}}} \leq 2CT$$

$$\sum_{n=0}^\infty\gamma^{\frac{n}{2T}-1}\Ea{}{f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}} \leq 2CT+\sum_{n=0}^\infty\exp\AP{\frac{1}{2}-\frac{n}{4T}}$$

$$\sum_{n=0}^\infty\gamma^{\frac{n}{2T}-1}\Ea{}{f_{K_n}\AP{X_{M_0},X_{M_1}\ldots X_{M_{K_n-1}},X_n}} \leq 2CT+\frac{\sqrt{e}}{1-\exp\AP{-\frac{1}{4T}}}\ \blacksquare$$

\textbf{Proposition A.16}\Co{b}

\textit{Consider $(\Omega,P)$ a probability space, $T\in\Nats^+$ and $\AC{N_k,\Delta_k:\Omega\rightarrow\Nats}_{k\in\Nats}$ random variables s.t. $N_{k+1}-N_k\geq\Delta_k$ and the $\Delta_k$ are all independent and uniformly distributed between $1$ and $2T-1$. Consider also $\gamma\in(0,1)$. Then,}\Co{i}

$$\sum_{k=0}^\infty\Ea{}{\gamma^{N_k}}\leq\frac{1}{\gamma^{2T-2}(1-\gamma)T}$$
...
$$\Ea{}{\gamma^{\Delta_0}}=\frac{1}{2T-1}\sum_{n=1}^{2T-1}\gamma^n\leq\frac{1}{2T-1}\sum_{n=1}^{2T-1}\AP{1-n(1-\gamma)\gamma^{n-1}}$$

$$\Ea{}{\gamma^{\Delta_0}}\leq\frac{1}{2T-1}\sum_{n=1}^{2T-1}\AP{1-n(1-\gamma)\gamma^{2T-2}}=1-T(1-\gamma)\gamma^{2T-2}$$
...
$$\Ea{}{\gamma^{N_k}}\leq\Ea{}{\prod_{l=0}^{k-1}\gamma^{\Delta_l}}=\prod_{l=0}^{k-1}\Ea{}{\gamma^{\Delta_l}}=\Ea{}{\gamma^{\Delta_0}}^k$$

Here, we used that the $\Delta_l$ are independent and equally distributed. It follows that

$$\sum_{k=0}^\infty\Ea{}{\gamma^{N_k}}\leq\sum_{k=0}^\infty\Ea{}{\gamma^{\Delta_0}}^k=\frac{1}{1-\Ea{}{\gamma^{\Delta_0}}}\leq\frac{1}{1-\AP{1-T(1-\gamma)\gamma^{2T-2}}}$$

$$\sum_{k=0}^\infty\Ea{}{\gamma^{N_k}}\leq\sum\frac{1}{T(1-\gamma)\gamma^{2T-2}}\ \ \blacksquare$$
...
$$\Reg(\gamma)\leq\sum_{k=0}^\infty\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\AP{(1-\gamma)\Abs{\Delta\R_k\AP{\Theta_n}}+\gamma\Abs{\CE{\Delta\SHy_k}{\V_{\SHy_k\R_k}(\gamma)}{\Theta_n,\AT_n}}}}$$
$$+\sum_{k=0}^\infty\Ea{}{{\gamma^{\IT_k}}\Abs{\CE{\Ev_{k*}^{\Delta\ET_k}-\Ev_{*k}^{\Delta\ET_k}}{\V_{\SHy_*\R_*}(\gamma)}{\Theta_{\ET_k}}}}$$
$$+(1-\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\IT_k}^{\ET_{k+1}-1}\gamma^n\Abs{\CE{\Ev_{**}^{n-\IT_k}-\Ev_{*k}^{n-\IT_k}}{\R_*}{\Theta_{\IT_k}}}}$$
$$+\sum_{k=0}^\infty\Ea{}{\gamma^{\ET_{k+1}}\Abs{\CE{\Ev_{**}^{\Delta\IT_k}-\Ev_{*k}^{\Delta\IT_k}}{\V_{\THy\R_*}(\gamma)}{\Theta_{\IT_k}}}}$$
...
$$\Reg(\gamma)\leq\sum_{k=0}^\infty\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\AP{(1-\gamma)\Abs{\Delta\R_k\AP{\Theta_n}}+\gamma\Delta\V(\gamma)\Dtva{\Delta\SHy_k\AP{\Theta_n,\AT_n}}}}$$
$$+\Delta\V(\gamma)\sum_{k=0}^\infty\Ea{}{{\gamma^{\IT_k}}}+(1-\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\IT_k}^{\ET_{k+1}-1}\gamma^n}+\Delta\V(\gamma)\sum_{k=0}^\infty\Ea{}{\gamma^{\ET_{k+1}}}$$
...
$$\Ea{}{\sum_{n=\IT_k}^{\ET_{k+1}-1}\gamma^n}\leq\Ea{}{\Delta M_k\gamma^{M_k}}=\Ea{}{\CE{}{\Delta M_k}{M_k}\gamma^{M_k}}\leq t_\Est\Ea{}{\gamma^{M_k}}$$

We get

$$\Reg_1(\gamma)\leq\Delta\V(\gamma)\sum_{k=0}^\infty\Ea{}{{\gamma^{\IT_k}}}+t_\Est(1-\gamma)\sum_{k=0}^\infty\Ea{}{\gamma^{M_k}}+\Delta\V(\gamma)\sum_{k=0}^\infty\Ea{}{\gamma^{\ET_{k+1}}}$$
...
That is, $\Theta_M^r$ is the history of reward estimation experiments. We apply Proposition B.1 with $\delta:=\frac{1}{2}(1-\gamma)^2$ and $\epsilon:=(1-\gamma)^2$, to each of the two terms in $\Reg_0(\gamma)$:

$$\Pa{}{\R_*\in\bigcap_{k=0}^\infty\CS^{\Hy_\R}\AB{\Theta_{M:k}^{r},\beta_\R(k+1)^{-1}}} \geq 1-\frac{1}{2}(1-\gamma)^2$$
$$\Pa{}{\SHy_*\in\bigcap_{n=0}^\infty\CS^{\Hy}\AB{\Theta\AT_{:n}\Theta_n,\beta_\T(n+1)^{-1}}} \geq 1-\frac{1}{2}(1-\gamma)^2$$
...
$$\Pa{}{\R_k\in\CS^{\Hy_\R}\AB{\Theta_{M:k}^{r},\beta_\R(k+1)^{-1}}} \geq 1-\frac{1}{2}(1-\gamma)^2$$
$$\Pa{}{\SHy_{k}\in\CS^\Hy\AB{\Theta\AT_{:N_k}\Theta_{N_k},\beta_\T\AP{N_k+1}^{-1}}} \geq 1-\frac{1}{2}(1-\gamma)^2$$

$$\Pa{}{\R_*,\R_k\in\CS^{\Hy_\R}\AB{\Theta_{M:k}^{r},\beta_\R(k+1)^{-1}}} \geq 1-(1-\gamma)^2$$
$$\Pa{}{\THy,\SHy_{k}\in\CS^\Hy\AB{\Theta\AT_{:N_k}\Theta_{N_k},\beta_\T\AP{N_k+1}^{-1}}} \geq 1-(1-\gamma)^2$$

Denote

$$\CSE_k:=\AC{\R_*,\R_k\in\CS^{\Hy_\R}\AB{\Theta_{M:k}^{r},\beta_\R(k+1)^{-1}}}\subseteq\Omega$$
$$\CSE'_k:=\AC{\THy,\SHy_{k}\in\CS^\Hy\AB{\Theta\AT_{:N_k}\Theta_{N_k},\beta_\T\AP{N_k+1}^{-1}}}\subseteq\Omega$$

Define $\Reg_{\Delta\R}(\gamma)$ and $\Reg_{\Delta\SHy}(\gamma)$ by

$$\Reg_{\Delta\R}(\gamma):=(1-\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}}}$$
$$\Reg_{\Delta\SHy}(\gamma):=\Delta\V(\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n+1}\Dtva{\Delta\SHy_k\AP{\Theta_n,\AT_n}}}$$

We have

$$\Reg_0(\gamma)=\Reg_{\Delta\R}(\gamma)+\Reg_{\Delta\SHy}(\gamma)$$

We split $\Reg_{\Delta\R}$ into the $\CSE_k$ and $\CSE_k^\complement$ contributions

$$\Reg_{\Delta\R}(\gamma)=(1-\gamma)\sum_{k=0}^\infty\Bigg(\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}};\CSE_k}+$$
$$\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}};\CSE^\complement_k}\Bigg)$$

For the second term, we have

$$\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}}\leq2T\gamma^{N_k}$$

$$\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}};\CSE^\complement_k}\leq2T\Ea{}{\gamma^{N_k};\CSE^\complement_k}\leq2T\min\AP{\Ea{}{\gamma^{N_k}},\Pa{}{\CSE_k^\complement}}$$

$$\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}};\CSE^\complement_k}\leq2T\min\AP{\Ea{}{\gamma^{N_k}},(1-\gamma)^2}$$

$$(1-\gamma)\sum_{k=0}^\infty\Ea{}{\sum_{n=\ET_k}^{\IT_k-1}\gamma^{n}\Abs{\Delta\R_k\AP{\Theta_n}};\CSE^\complement_k}\leq ??$$

% We need to extend Proposition A.16 to either cover this case or give the expression for E[\gamma^{N_k}]

$$???\Reg_0(\gamma)\leq\Delta\V(\gamma)\sum_{n=0}^\infty\gamma^{n}\AP{\Ea{}{\Dtva{\SHy_n\AP{\Theta_n,\AT_n},\THy\AP{\Theta_n,\AT_n}};\CSE_n }+(1-\gamma)^2}$$
...
$$\Reg(\gamma)\leq\Delta\V(\gamma)\AP{\frac{1}{2}?\sum_{n=0}^\infty\gamma^{n}\Ea{}{\sqrt{?\AP{\SHy_n\AP{\Theta_n,\AT_n}-\THy\AP{\Theta_n,\AT_n}}^{\otimes2}};\CSE_n }+1-\gamma+\frac{1}{1-\gamma^T}}$$

Denote

$$\Hy_l:=\CS^\Hy\AB{\Theta\AT_{:lT}\Theta_{lT},\beta(lT+1)^{-1}?}$$
...
$$\Reg(\gamma)\leq\Delta\V(\gamma)\AP{\frac{1}{2}?\Ea{}{\sum_{n=0}^\infty\gamma^{n}\W^{\Hy_{\Floor{n/T}}}\AP{\Theta_n\AT_n,B} }+1-\gamma+\frac{1}{1-\gamma^T}}$$

We will now assume $\DRVO>0$ (if $\DRVO=0$, then $\Abs{\Hy}=1$ and $\Reg(\gamma)=0$) and $\gamma^T>\frac{1}{2}$. Applying Proposition ??, we conclude

$$\Reg(\gamma)\leq\Delta\V(\gamma)\AP{\frac{? C_{\mathrm{A.6}}}{2}\AP{\DRVO T+\sqrt{\DRVO\beta\AP{\frac{1}{1-\gamma}}\frac{1}{1-\gamma}}}+1-\gamma+\frac{1}{1-\gamma^T}}$$

Denote the second factor on the right hand side $F(\gamma)$, so that the inequality becomes 

$$\Reg(\gamma)\leq\Delta\V(\gamma)F(\gamma)$$
