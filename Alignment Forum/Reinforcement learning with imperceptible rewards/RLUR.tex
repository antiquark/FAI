...
$$\limsup_{\gamma \rightarrow 1}\frac{\sqrt{\DRVO(1-\gamma)\ln\frac{1}{1-\gamma}\cdot T}}{\sqrt[3]{\AP{\tau+t_{\Est}}\AP{\DMB+1}\DRVO(1-\gamma)\ln{\frac{1}{1-\gamma}}}}\lesssim\frac{1}{\sqrt[3]{\DMB+1}}$$
