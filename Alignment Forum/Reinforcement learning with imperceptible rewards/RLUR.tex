...
Applying Proposition A.19, we conclude

$$\frac{\gamma^T}{1-\gamma^T}\sum_{k=0}^{\infty}\gamma^{kT}\sum_{n=N_k}^{N_{k+1}-1}{\boldsymbol{1}_{\W^{\F^k}\AP{\boldsymbol{x}_{n}}>\theta}} \leq \frac{D+1}{T\gamma^T}\cdot\frac{?}{\ln\frac{1}{\gamma}}\AP{\frac{4\beta\AP{\frac{1}{\ln\frac{1}{\gamma}}+1}}{\theta^2}+T}$$
