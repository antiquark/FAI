...
Denote $\Ev_{kk}:=\SHy_k\Pi\AP{\SHy_k}$. Substituting $s=\Theta_{kl}$ and subtracting the two identities, we get that, in the subspace of $\Omega$ defined by $l<\Delta\Phi_k$

$$\Ea{}{\Delta\V_{kl}}=\Ea{}{(1-\gamma)\Delta\R\AP{\Theta_{kl}}+\gamma\AP{\CE{\Ev_{kk}}{\V_l}{\Theta_{kl}}-\CE{\Ev_{*k}}{\V_{l,k+1}}{\Theta_{kl}}}}$$

Denote $\AT_{kl}:=\AT_{\Phi_k+l}$. Since $\Pi\AP{\SHy_{k}}$ is exactly the policy followed by PSRL at time $\Phi_k+l$, we get

$$\Ea{}{\Delta\V_{kl}}=\Ea{}{(1-\gamma)\Delta\R\AP{\Theta_{kl}}+\gamma\AP{\CE{\SHy_k}{\V_l}{\Theta_{kl},\AT_{kl}}-\CE{\THy}{\V_{l,k+1}}{\Theta_{kl},\AT_{kl}}}}$$
...
Applying this to each term in the earlier expression for $\Reg(\gamma)$, we get the desired result.
