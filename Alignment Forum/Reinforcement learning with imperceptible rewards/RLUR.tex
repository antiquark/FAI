...
$$\Reg_\T(\gamma)\leq\Delta\V(\gamma)\AP{\frac{\Abs{S}}{2}\E{\sum_{i=0}^\infty\gamma^{L_i}\W^{\Hy_\T^{K_i}}\AP{\Theta_{L_i}}}+\rho(\gamma,T)}$$

% Apply Proposition A.14...
% We need to either generalize Proposition A.21 to allow for "skipped" periods,
% Or change the define of \Hy_\T to "update" only inside episodes
