...
??? % Proposition needs to be reversed
% We need to show that the probability K is *large* is small
% Equivalently, the probability that K is small is *large*
% The current, erroneous direction, can (qualitatively) be proven with probability *1* w/o Hoeffding
