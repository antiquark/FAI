...
\textit{Denote $\R_k:=\R_{\SHy_k}$, $\R_*:=\R_{\THy}$, $\Delta\R_k:=\R_k-\R_*$, $\Delta\SHy_k:=\SHy_k-\THy$, $\Ev_k:=\SHy_*\Pi\AP{\SHy_{k}}$, $\bar{\Ev}_k:=\SHy_{k}\Pi\AP{\SHy_*}$ and $\Ev_*:=\THy\Pi\AP{\THy}$. Then,}\Co{i}
...
$$+\sum_{k=0}^\infty\Ea{}{{\gamma^{\IT_k}}\CE{\bar{\Ev}_{k}^{\IT_k-\ET_k}-\Ev_{k}^{\IT_k-\ET_k}}{\V_{\SHy_*\R_*}(\gamma)}{\Theta_{\ET_k}}}$$
$$+\sum_{k=0}^\infty\Ea{}{\sum_{n=\IT_k}^{\ET_{k+1}-1}\gamma^n\CE{\Ev_*^{n-\IT_k}-\Ev^{n-\IT_k}}{\R_*}{\Theta_{\IT_k}}}$$
$$+\sum_{k=0}^\infty\Ea{}{\gamma^{\ET_{k+1}}\CE{\Ev_*^{\ET_{k+1}-\IT_k}-\Ev^{\ET_{k+1}-\IT_k}}{\V_{\THy\R_*}(\gamma)}{\Theta_{\IT_k}}}$$
