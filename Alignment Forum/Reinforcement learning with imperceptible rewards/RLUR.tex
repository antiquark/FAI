...
$$\R=\Prj^\omega_{n_0}\circ\R_{n_0}+\sum_{k=0}^\infty\Prj^\omega_{n_{k+1}}\circ\Delta\R_k=C\AP{\frac{1}{C}\Prj^\omega_{n_0}\circ\R_{n_0}+\sum_{k=0}^\infty\frac{\delta_k}{C}\cdot\frac{\Prj^\omega_{n_{k+1}}\circ\Delta\R_k}{\delta_k}}$$
