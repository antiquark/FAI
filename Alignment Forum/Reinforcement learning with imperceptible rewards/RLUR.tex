...
First, we analyze $\Reg_1(\gamma)$. In the second term, we have $\gamma^n\leq\gamma^{M_k}$, leading to
...
Now, we analyze $\Reg_0(\gamma)$. Define $\Theta_M^r\in\AP{\St\times\Reals}^\omega$ by
...
$$\CSE_n:=\AC{\SHy_*,\SHy_{lT}\in\CS^\Hy\AB{\Theta\AT_{:lT}\Theta_{lT},\beta(lT+1)^{-1}?}}\subseteq\Omega$$
