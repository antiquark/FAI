...
Fix $\R:\IS_\omega\rightarrow[0,1]$ continuous affine. For any $\T$ as above, we get the induced reward function $\R_\T:\St\rightarrow[0,1]$ given by $\R_\T:=\R\circ\In_{\T^\sharp}$. More generally... %semi-instrumental We can now consider the learning problem corresponding to a hypothesis class of MDP transition kernels
