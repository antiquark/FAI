...
$$\limsup_{\gamma \rightarrow 1}\frac{\AP{T\Ceil{\frac{\ln(1-\gamma)}{\ln\AP{1-\frac{1}{2}T(1-\gamma)}}}(1-\gamma)^3}}{\sqrt[3]{\AP{\tau+t_{\Est}}\AP{\DMB+1}\DRVO(1-\gamma)\ln{\frac{1}{1-\gamma}}}}=0$$
