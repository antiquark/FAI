...
\newcommand{\Con}{\boldsymbol{\mathrm{Con}}}
\newcommand{\M}{\mathrm{Mor}}
...
First, it will be convenient to work with the category $\Con$ whose objects are pairs $(V,C)$ where $V$ is a real vector space and $C$ is a convex subset of $V$, and whose morphisms are
