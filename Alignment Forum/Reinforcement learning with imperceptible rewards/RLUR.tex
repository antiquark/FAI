...
\textcolor{red}{TODO: Define $\theta(o\mid h)$ !!!}
...
Of course, $\IS_\omega$ can also be regarded as the space of all possible stochastic environments.
...
$$\Pa{ao\sim\mu\pi}{\Abs{ao}<\infty} = 1$$
