...
\textit{Here, $M_{-1}$ is understood to identically equal $0$.}\Co{i}
...
$$\Pa{}{M_k\geq (k+1)T+m}\leq\exp\AP{-\frac{2m^2}{(k+1)\AP{2T-2}^2}}$$
...
% We need to reverse Propositon A.14: show why the probability tht {K_n is small} is small
