...
\textit{Consider some $\theta,\theta'\in\IS_n$ and assume that for any $\pi:\AP{\A\times\Ob}^{<n}\rightarrow\A$, $\theta\pi=\theta'\pi$. Then, $\theta=\theta'$.}\Co{i}

\textbf{Proposition 2}\Co{b}

\textit{Consider some $\theta,\theta'\in\IS_n$,  $\pi:\AP{\A\times\Ob}^{<n}\K\A$ and $p\in[0,1]$. Then}\Co{i}
...
\textit{Given $\mu\in\IS_\omega$ and $\pi:\AP{\A\times\Ob}^{*}\K\A$, we define $\mu\pi\in\Delta\AP{\A\times\Ob}^\omega$ by}\Co{i}

$$\Pa{ao\sim\mu\pi}{a_n=b}=\Ea{ao\sim\mu\pi}{\pi\APM{b}{ao_{:n}}}$$
$$\Pa{ao\sim\mu\pi}{o_n=p}=\Ea{ao\sim\mu\pi}{\mu\APM{p}{ao_{:n}a_n}}$$

\textbf{Proposition 3}\Co{b}

\textit{Consider some $\mu,\mu'\in\IS_\omega$ and assume that for any $\pi:\AP{\A\times\Ob}^{*}\rightarrow\A$, $\mu\pi=\mu'\pi$. Then, $\mu=\mu'$.}\Co{i}

\textbf{Proposition 4}\Co{b}

\textit{Consider some $\mu,\mu'\in\IS_\omega$,  $\pi:\AP{\A\times\Ob}^{*}\K\A$ and $p\in[0,1]$. Then}\Co{i}
...
We proceed by induction on $n$. For $n=0$ there is nothing to prove since $\IS_0=\Pt$ so $\theta=\theta'$ a priori.

We need to show that for any $b\in\A$, $\theta_b=\theta'_b$. To show it for given $b$, we consider some $\pi$ s.t. $\pi(\Estr)=b$. Since $\theta\pi=\theta'\pi$, for any $p\in\Ob$ we have

$$\Pa{ao\sim\theta\pi}{o_0=p}=\Pa{ao\sim\theta'\pi}{o_0=p}$$

By Definition 7, we get,

$$\theta(p\mid b)=\theta'(p\mid b)$$

By Definition 6, we get,

$$\Ht_{\IS_{n-1}}\Big(\theta_{bp}\Big)=\Ht_{\IS_{n-1}}\AP{\theta'_{bp}}$$
