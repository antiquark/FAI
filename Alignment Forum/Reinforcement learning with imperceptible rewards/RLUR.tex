...
$$\Abs{\ACM{\AP{k\in[K],n\in\Nats}}{N_k\leq n<N_{k+1},\ \W^{\F^{k}}\AP{\boldsymbol{x}_{n}}>\theta}}\leq\RVO{\F}\cdot\AP{\frac{4\beta_{K}}{\theta^{2}}+T}$$
...
By the construction, $a_j\in A'$ and therefore $\W^{\F^{k?}}\AP{\boldsymbol{x}_{a_j}}>\theta$...
