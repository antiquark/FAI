...
% We should also allow for extra Delta terms in order to use together with Proposition A.20
...
$$\sqrt{\DRVO\ln\N\AP{\Hy_\R,(1-\gamma)^{-4}}}\cdot(1-\gamma)T+$$
$$\sqrt{\DRVO\ln\frac{1}{1-\gamma}}\cdot(1-\gamma)T+$$
$$\frac{1-\gamma}{1-\exp\AP{-\frac{1}{4T}}}+$$
$$T\Ceil{\frac{\ln(1-\gamma)}{\ln\AP{1-\frac{1}{2}T(1-\gamma)}}}(1-\gamma)^3+$$
$$(1-\gamma)^2+$$
$$\frac{1}{T}$$

Here we used that $1\lesssim\gamma^T\leq1$ and substituted the expressions for $\tilde{\beta}_\R$, $\tilde{\beta}$ and $\rho$.
...
$$\limsup_{\gamma \rightarrow 1}\frac{\sqrt{\DRVO\ln\N\AP{\Hy_\R,(1-\gamma)^{-4}}}\cdot(1-\gamma)T}{\sqrt[3]{\AP{\tau+t_{\Est}}\AP{\DMB+1}\DRVO(1-\gamma)\ln{\frac{1}{1-\gamma}}}}=0???$$

...

$$\limsup_{\gamma \rightarrow 1}\frac{\Reg(\gamma)}{\sqrt[3]{\AP{\tau+t_{\Est}}\AP{\DMB+1}\DRVO(1-\gamma)\ln{\frac{1}{1-\gamma}}}}$$

$$\beta(t):=C_{\mathrm{A.4}}\AP{\ln{\frac{\N(\F,\epsilon^{-2} )}{\delta}}+\epsilon t\ln{\frac{et}{\delta}}}$$

$$\tilde{\beta}_\R(\gamma,T,\DRVO)=C_{\text{A.21}}\AP{\DRVO +\sqrt{\DRVO\beta_\R\AP{\frac{1}{1-\gamma^{\frac{1}{2}T}}}\frac{1}{1-\gamma^{\frac{1}{2}T}}}}$$
$$\rho(\gamma,T)=2T\Ceil{\frac{2\ln(1-\gamma)}{\ln\AP{1-\frac{1}{2}T(1-\gamma)}}}(1-\gamma)^2+4(1-\gamma)$$
$$\Reg_\R(\gamma)\leq(1-\gamma)\AP{\gamma^{-\frac{1}{2}T}\AP{2T\tilde{\beta}_\R(\gamma,T,\DRVO)+\frac{1}{1-\exp\AP{-\frac{1}{4T}}}}+\rho(\gamma,T)}+\frac{2}{T}$$
