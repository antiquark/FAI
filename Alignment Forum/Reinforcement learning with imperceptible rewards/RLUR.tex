...
\textit{Let $\A$ be a finite set, $C\in\Con$ and $\R\in\Mor\AP{C^\A,[0,1]}$. Assume $\R$ attains its infimum at some point $\theta^*\in C^\A$. Then, there exist $\pi\in\Delta\A$ and $r:\A\rightarrow\Mor\AP{C,[0,1]}$ s.t.}\Co{i} 
