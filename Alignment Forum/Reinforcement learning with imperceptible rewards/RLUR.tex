...
By Proposition A.10, for every $k\in\Nats$, there is $\pi_k:\AO^{<n_{k+1}}\K\A$ and $r_k:\AO^{n_{k+1}}\rightarrow[0,1]$ s.t.

$$\Delta\R_k(\theta)=\Ea{\theta\pi_k}{r_k}$$

Denote $\delta_k:=\sup\Delta\R_k$. By the construction, $\sum_{k=0}^\infty\delta_k < 1$...
