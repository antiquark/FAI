...
Fix $\A$ and $\Ob$. For any $\St$ and $\T:\St\times\A\K\St\times\Ob$, there is a unique mapping $\In_\T:\St\rightarrow\IS_{\omega}$ s.t. 

$$\In_\T(s)...$$

...Fix $\R:\IS_\omega\rightarrow\Reals$ continuous affine...

...One natural setting for a regret analysis is a fixed reward function $\R:\IS_\omega\rightarrow\Reals$ and a hypothesis class of transition kernels...
