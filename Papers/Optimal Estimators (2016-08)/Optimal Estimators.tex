...
The following propositions are basic properties of samplable ensembles and problems which often come in handy. \textcolor{red}{Proposition~\ref{prp:smp} states that the expectation of a function $h(x)$ remains approximately unchanged when $x$ is replaced with a sampler of $\Dist$, and Proposition~\ref{prp:gen} states that the expectation of the product of $h(x)$ and $f(x)$ remains unchanged when $x$ and $f(x)$ are replaced by question/answer pairs produced by a sampler for $(\Dist,f)$.}
