...
For distributional decision problems and ${\EG}$-samplable word ensembles we have the following stronger proposition: \textcolor{red}{given an optimal estimator, we get not just a perfect estimator, but an algorithm that depends only on $K$ and doesn't need a problem instance.}
