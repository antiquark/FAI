...
\textcolor{red}{(encodings of the randomness functions and algorithms, which by the definition of a uniform family, is a finite set.)} For any ${K,L \in \Nats^n}$, ${x \in X}$ and ${y,z \in \Words}$
