...
Thus, $\SVM G^F_n\left(y\right)$ is the minimal possible payoff of the first $n$ gambles and $\SVX G^F_n\left(y\right)$ is the maximal possible payoff.
...
In the following, we will use the notation $S_n(y;\mu)$ to mean $S_n(y)(\mu)$.
