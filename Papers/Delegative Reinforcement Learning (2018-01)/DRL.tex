...
That is, $\A_M^0(s)$ is the set of actions at state $s$ that don't destroy value in the long run.
...
\begin{equation}
\Ea{x\sim\pi^{\dagger L^k}}{\Abs{\ACM{n\in\Nats}{x_n\in\St\times\A}}} \leq ??
\end{equation}
