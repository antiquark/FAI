...
We start by reviewing some basic definitions and properties of Markov decision processes. First, some notation. 
...
Finally, it is well known that there is some $\gamma_M\in[0,1)$ s.t. for any $\gamma\in(0,1)$, if $\gamma > \gamma_M$ then...
