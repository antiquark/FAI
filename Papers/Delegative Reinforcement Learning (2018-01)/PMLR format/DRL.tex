...
The difference between $\pi^{\star k}_n$ and $\pi^{\sharp k}_n$ is that the latter sometimes delegates even in the $n$-th (and later) episodes.

% Proposition A.2 (condition i) in 1656: is it really for all k or only on average over k?
