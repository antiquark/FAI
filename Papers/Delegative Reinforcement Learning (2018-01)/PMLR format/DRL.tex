...
Observe that, in the imaginary setting, the policy $\IP: \St_\X^* \times \St_\X \K \A_\X$ computed by our algorithm (which depends explicitly on $k$ because $k$ determines $\beta$) has the property
