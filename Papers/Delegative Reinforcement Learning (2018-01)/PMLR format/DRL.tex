...
$$\Rg^{\pi_l^\star} = \sum_{n=0}^\infty{\gamma^n \Ea{x\sim M\pi_l^\star}{\V\AP{x_{n}}-\Q_{\pi^\star_l}\AP{x_{:n+1}}}}$$

$\pi^\star_l$ coincides with $\pi^\star$ after $lT$, therefore the corresponding terms on the right hand side vanish.

$$\Rg^{\pi_l^\star} = \sum_{n=0}^{lT-1}{\gamma^n \Ea{x\sim M\pi^0}{\V\AP{x_{n}}-\Q_{\pi^0}\AP{x_{:n+1}}}}$$

Subtracting the equalities for $l+1$ and $l$, we get

$$\EU^{\pi_{l}^\star} - \EU^{\pi_{l+1}^\star} = \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{x\sim M\pi^0}{\V\AP{x_{n}}-\Q_{\pi^0}\AP{x_{:n+1}}}}$$

$$(1-\gamma)\sum_{n=0}^\infty {\gamma^n\AP{\Ea{M\pi^\star_l}{\R\AP{x_{n}}}-\Ea{M\pi^\star_{l+1}}{\R\AP{x_{n}}}}} = \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{M\pi^0}{\V\AP{x_{n}}-\Q_{\pi^0}\AP{x_{:n+1}}}}$$

$\pi^\star_l$ and $\pi^\star_{l+1}$ coincide until $lT$, therefore

$$(1-\gamma)\sum_{n=lT}^\infty {\gamma^n\AP{\Ea{M\pi^\star_l}{\R\AP{x_{n}}}-\Ea{M\pi^\star_{l+1}}{\R\AP{x_{n}}}}} = \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{M\pi^0}{\V\AP{x_{n}}-\Q_{\pi^0}\AP{x_{:n+1}}}}$$
...
\begin{align*}
(1-\gamma)\sum_{n=lT}^{(l+1)T-1} {\gamma^n\AP{\Ea{M\pi^\star_l}{\R\AP{x_{n}}}-\Ea{M\pi^\star_{l+1}}{\R\AP{x_{n}}}}} + \gamma^{(l+1)T}\AP{\Ea{M\pi^\star_l}{\V\AP{x_{(l+1)T}}}-\Ea{M\pi^0}{\V\AP{x_{(l+1)T}}}}\\ 
= \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{M\pi^0}{\V\AP{x_{n}}-\Q_{\pi^0}\AP{x_{:n+1}}}}
\end{align*}
