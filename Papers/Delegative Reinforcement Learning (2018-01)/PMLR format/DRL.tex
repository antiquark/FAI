...
\begin{equation}
\Rg_{M}^{\pi}(\gamma)=\sum_{n=0}^\infty {\gamma^n \Ea{x\sim M\pi}{\V_{M}\AP{x_n,\gamma}-\Ea{a\sim\pi\AP{x_{:n},x_n}}{\Q_{M}\AP{x_n,a,\gamma}}}}
\end{equation}
...
\begin{align*}
\EU^{\star} - \Ut(x)=\sum_{n=0}^\infty \gamma^n &\AP{\V\AP{x_{n}}-(1-\gamma)\R\AP{x_{n}}-\gamma\V\AP{x_{n+1}}} \\ =\sum_{n=0}^\infty \gamma^n &\Big(\V\AP{x_{n}}-\Ea{\pi\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}
\\ &+\Ea{\pi\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}-(1-\gamma)\R\AP{x_{n}}-\gamma\V\AP{x_{n+1}}\Big)
\end{align*}

Taking expected value over $x$ w.r.t. $M\pi$, we get

\begin{align*}
\Rg^{\pi}=\sum_{n=0}^\infty \gamma^n \Bigg(&\Ea{M\pi}{\V\AP{x_{n}}-\Ea{\pi\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}} \\ 
+&\Ea{M\pi}{\Ea{\pi\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}-(1-\gamma)\R\AP{x_{n}}-\gamma\V\AP{x_{n+1}}}\Bigg)
\end{align*}
...
\item For any $s \in \St_M$, $\Supp{\pi^\star(s)} \subseteq \A_M^\star(s)$.
\item For any $h \in \FH_{M\pi^0}$ and $s \in \St_M$, $\Supp{\pi^0(h,s)} \subseteq \A_{M}^0\AP{s}$.
...
% Use the notation Q_{M\pi} to denote E[Q_M]...
...
$$\Rg^{\pi_l^\star} = \sum_{n=0}^\infty{\gamma^n \Ea{x\sim M\pi_l^\star}{\V\AP{x_{n}}-\Ea{a\sim\pi^\star_l\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}}}$$

$\pi^\star_l$ coincides with $\pi^\star$ after $lT$, therefore the corresponding terms on the right hand side vanish.

$$\Rg^{\pi_l^\star} = \sum_{n=0}^{lT-1}{\gamma^n \Ea{x\sim M\pi^0}{\V\AP{x_{n}}-\Ea{a\sim\pi^0\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}}}$$

Subtracting the equalities for $l+1$ and $l$, we get

$$\EU^{\pi_{l}^\star} - \EU^{\pi_{l+1}^\star} = \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{x\sim M\pi^0}{\V\AP{x_{n}}-\Ea{a\sim\pi^0\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}}}$$

$$(1-\gamma)\sum_{n=0}^\infty {\gamma^n\AP{\Ea{M\pi^\star_l}{\R\AP{x_{n}}}-\Ea{M\pi^\star_{l+1}}{\R\AP{x_{n}}}}} = \sum_{n=lT}^{(l+1)T-1}{\gamma^n \Ea{M\pi^0}{\V\AP{x_{n}}-\Ea{\pi^0\AP{x_{:n+1}}}{\Q\AP{x_{n},a}}}}$$
