...
% Random variable: K (env)
% Stochastic processes: advisor actions, experimental actions, knowledge state
% Assumption: knowledge calibrated given advisor actions
% Definition: agent action as a function of knowledge state and experimental action
% Claim: expected number of delegating agent actions...
% Claim: all agent actions are safe... (tautology?)
% Claim: if agent does non-experimental action then experimental is unsafe... (tautology?)
