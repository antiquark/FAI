...
$$\EU_{\upsilon^\kappa}^{\pi^0}(t) = (1-e^{-1/t})\E{x\sim\mu\bowtie\pi^0}[\sum_{n=0}^\infty e^{-n/t} (\sum_{m=0}^{n} \prod_{l=0}^{m-1}{(1-\kappa_t(x_{:l}))}\kappa_t(x_{:m}) \V^{-\upsilon}_t(x_{:m})+{(1-\hat{\kappa}_t(x_{:n}))}r_t(x_{:n}))]$$

$$\EU_{\upsilon^\kappa}^{\pi^0}(t) \leq (1-e^{-1/t})\E{x\sim\mu\bowtie\pi^0}[\sum_{n=0}^\infty e^{-n/t} (\sum_{m=0}^{n} \prod_{l=0}^{m-1}{(1-\kappa_t(x_{:l}))}\kappa_t(x_{:m}) \E{y\sim\mu\bowtie\pi^0}[\frac{\sum_{l=m}^\infty e^{-l/t} r(y_{:l})}{\sum_{l=m}^\infty e^{-l/t}} \mid x_{:m}]+(1-\hat{\kappa}_t(x_{:n}))r_t(x_{:n}))]$$

$$\EU_{\upsilon^\kappa}^{\pi^0}(t) \leq (1-e^{-1/t})\E{x\sim\mu\bowtie\pi^0}[\sum_{n=0}^\infty e^{-n/t} (\sum_{m=0}^{n} \prod_{l=0}^{m-1}{(1-\kappa_t(x_{:l}))}\kappa_t(x_{:m}) \frac{\sum_{l=m}^\infty e^{-l/t} r(x_{:l})}{\sum_{l=m}^\infty e^{-l/t}} +(1-\hat{\kappa}_t(x_{:n}))r_t(x_{:n}))]$$
