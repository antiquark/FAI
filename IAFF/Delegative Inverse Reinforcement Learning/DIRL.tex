...
$$\W_t^\upsilon(ha):=r(h)+\E{o \sim \mu(ha)}[V_t^\upsilon(hao)]$$
...
For any $k \in [N]$, and $\I$-policy $\pi^0$ we have

$$\max_{\pi \in \Pi_\I} \EU_{\upsilon^k}^{\pi}(t) - \EU_{\upsilon^k}^{\pi^0}(t)=\E{\mu^k_t \bowtie \pi^0}[\sum_{n=0}^\infty e^{-n/t} (?-?)]$$
