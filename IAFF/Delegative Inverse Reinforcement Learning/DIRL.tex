...
For any $k \in [N]$, Proposition A.5 yields
...
$$\frac{1}{N}\sum_{k < N}(\EU_{\bar{\upsilon}^k[\alpha^k]}^{*}(t) - \EU_{\bar{\upsilon}^k[\alpha^k]}^{\pi^{!k}}(t)) \leq \frac{\beta(t)^{-1}t^{-1/3}}{1 - e^{-1/t}}+\frac{8 \Abs{\A}^2 \ln{N}}{(1-e^{-1})^2}t^{2/3}\Abs{\A}e^{-1}\beta(t)^{-1}$$
