...
$$\max_{\pi \in \Pi_\I} \EU_{\upsilon}^{\pi}(t)=\V^{\upsilon}_t(\Estr)=\sum_{n=0}^\infty e^{-n/t} (\V^{\upsilon}_t(x_{:n})-e^{-1/t}\V^{\upsilon}_t(x_{:n+1}))$$

$$\Ut^{r}_t(x)=(1-e^{-1/t})\sum_{n=0}^\infty e^{-n/t} r(x_{:n})$$

$$\max_{\pi \in \Pi_\I} \EU_{\upsilon}^{\pi}(t) - \Ut^{r}_t(x)=\sum_{n=0}^\infty e^{-n/t} (\V^{\upsilon}_t(x_{:n})-(1-e^{-1/t})r(x_{:n})-e^{-1/t}\V^{\upsilon}_t(x_{:n+1}))$$

$$\max_{\pi \in \Pi_\I} \EU_{\upsilon}^{\pi}(t) - \Ut^{r}_t(x)=\sum_{n=0}^\infty e^{-n/t} (\V^{\upsilon}_t(x_{:n})-\W^{\upsilon}_t(x_{:n+1/2})+\W^{\upsilon}_t(x_{:n+1/2})-(1-e^{-1/t})r(x_{:n})-e^{-1/t}\V^{\upsilon}_t(x_{:n+1}))$$

...and $\I$-policy $\pi^0$ we have

$$\max_{\pi \in \Pi_\I} \EU_{\upsilon}^{\pi}(t) - \EU_{\upsilon}^{\pi^0}(t)=\E{x \sim \mu_t \bowtie \pi^0}[\frac{\sum_{n=0}^\infty e^{-n/t} (\V^{\upsilon}_t(x_{:n})-\W^{\upsilon}_t(x_{:n+1/2}))}{\sum_{n=0}^\infty e^{-n/t}}]$$
