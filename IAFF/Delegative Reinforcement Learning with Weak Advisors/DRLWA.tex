...
Fix $\gamma \in (0,1)$ and $T \in \Nats$. Denote $\F:=\bigcup_{k \in [N]} \HD{\mu^k}$. Let $(\Omega,P \in \Delta\Omega)$ be a probability space and $Z,\tilde{Z}:  \Omega \times \F \rightarrow \Delta[N]$, $\Gamma: \Omega \times \F \rightarrow [N]$ and $\Pi: \Omega \times \F \rightarrow \A!$ measurable in the $\Omega$ argument s.t.
