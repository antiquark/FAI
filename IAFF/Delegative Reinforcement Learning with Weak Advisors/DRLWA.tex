...
In order to proof $\pi^*$ has the desired property, we will require several more stochastic processes (thus $\Omega$ is constructed to accommodate them). For any $k \in [N]$, we have
