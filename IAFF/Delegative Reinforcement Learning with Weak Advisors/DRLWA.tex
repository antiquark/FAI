...
% Decompose expected utility into expected utility of expected utility conditional on Z^!
% Use convexity of square
% Apply A.N1 to get the expected difference in Z^! entropy
