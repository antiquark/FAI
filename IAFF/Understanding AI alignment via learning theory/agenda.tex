...
Finally, whatever the ultimate value learning protocol will be, it is desirable to have it grounded in a coherent theory of imperfect rationality. Specifically LBT suggests 3 types of "flaws" an agent is allowed to have while maintaining particular values:

* Its modeling abilities are limited: some computable and even efficiently computable models don't appear in its prior...
