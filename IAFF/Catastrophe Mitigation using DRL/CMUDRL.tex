...
It is easy to see that $\tilde{M}^k\AB{\tilde{\sigma}^k}$ is a $2\delta$-perturbation of $M^k\AB{\sigma^k}$. Observe also that

% No, since on the LHD the prob. of advisor actions are renormalized by resulting state probabilities
% whereas on the RHS the prob. of advisor actions correspon to the actual \tilde{\sigma}

$$\upsilon^{k}\AB{\sigma^k S^k}^{\tilde{M}^k\AB{\tilde{\sigma}^k}\RMD} = \overline{\tilde{\upsilon}^{k\RMD}}\AB{\tilde{\sigma}^k S^{k\star}}???$$

$$\upsilon^{k}\AB{\sigma^k S^k}^{\tilde{M}^k\AB{\tilde{\sigma}^k}\RME} = \overline{\tilde{\upsilon}^{k\RME}}\AB{\tilde{\sigma}^k S^{k\star}}???$$

Applying Proposition A.N5, we get

$$\frac{1}{2}\AP{\EU_{\upsilon^k}^{\pi^k S^{k}}(1-\alpha)-\EU_{\bar{\upsilon}^k\AB{\sigma^k S^k}}^{\pi^\sharp\Re^*}(1-\alpha)} \leq O\AP{\bar{\tau}_2 \alpha + (\bar{\tau}_1 \alpha)^{1/4} + \delta\AP{\bar{\tau}_1+\frac{\bar{\tau}_2 \alpha + (\bar{\tau}_1 \alpha)^{1/4}}{\alpha}}}???$$
