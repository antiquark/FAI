...
Fix $\delta\in(0,1)$ and consider $M$ a $\delta$-catastrophe MDP. We define the MDPs $\MD$ and $\ME$ as follows.
...
% Given regret wrt a \delta-perturbation of M we get regret wrt M?
% Needs assumption on mitigation time...
% Role of \delta-perturbation of policy... ?
