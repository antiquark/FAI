...
Note also that $M[\sigma]^\RMD = M^\RMD[\sigma]$ and $M[\sigma]^\RME = M^\RME[\sigma]$ (where interpreting $\sigma$ as a policy for $M^\RMD$ or $M^\RME$ requires choosing an arbitrary value for the state $\bot$).
...
%It is easy to see that $\AB{\tilde{\sigma}^k S^{k\star}}\underline{\pi}^\sharp$ is a $\delta$-perturbation of $\AB{\sigma^k S^{k\star}}\underline{\pi}^\sharp$ over $S^{k\star}$???

It is easy to see that $\tilde{M}^k\AB{\tilde{\sigma}^k}$ is a $2\delta$-perturbation of $M^k\AB{\sigma^k}$.

??? What are $M[\sigma]^\RMD$ and $M[\sigma]^\RME$ ???
