...
\author{Vadim Kosoy\thanks{Institution Affiliation, City, State
    (\email{vadim.kosoy@intelligence.org}, \url{https://intelligence.org/}).}}
...
% REQUIRED
\begin{keywords}
  %Three(ish) keywords, separated by commas
\end{keywords}

% REQUIRED
\begin{AMS}
  %We need to enter AMS numbers here. http://www.ams.org/mathscinet/msc/msc2010.html
  %68Q25, 68R10, 68U05
\end{AMS}

\sloppy %%%There are a TON of overfull lines! Trying to fix them all in one go.
