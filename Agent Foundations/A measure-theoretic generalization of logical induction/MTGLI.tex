...
Then, ${\B T}$ is also a trader (i.e. it is continuous in the last argument). Moreover, it satisfies
...
* The following set is either unbounded from below or bounded from above:
