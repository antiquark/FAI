...
$$\SWm \B T_{m_0+1}(\{\mu_l \}_{l \leq m_0}) = \min_{x \in X_{m_0+1}} \SW \B T_{m_0+1}(\{\mu_l \}_{l \leq m_0})$$

$$\SWm \B T_{m_0+1}(\{\mu_l \}_{l \leq m_0}) = \min_{x \in X_{m_0+1}} (\SW \B T_{m_0}(\{\mu_l \}_{l < m_0}) + \W \B T_{m_0}(\{\mu_l \}_{l \leq m_0}))$$
...
$$\SWm \B T_{m_0+1}(\{\mu_l \}_{l \leq m_0}) = \min_{x \in X_{m_0+1}} (\SW T_{m_0}(\{\mu_l \}_{l < m_0}) + \N T_{m_0}(\{\mu_l \}_{l \leq m_0}) \W T_{m_0}(\{\mu_l \}_{l \leq m_0}))$$
