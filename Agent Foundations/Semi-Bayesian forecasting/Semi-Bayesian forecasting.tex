...
$$U(\pi \otimes_\alpha \rho^*,\mu) \geq \max_{\rho: T \rightarrow \Prob(S_2)} \min_{\mu' \in \Phi} U(\pi \otimes_\alpha \rho, \mu')-2\frac{(\sup u_2 - \inf u_2)\mu(A)\Dtv(\mu \mid A, \nu^* \mid A)}{\frac{p}{1-p}\frac{\mu(A)}{\nu^*(A)}+1}$$
...
Consider any ${\mu' \in \Phi}$ and denote ${\xi = p\mu' + (1-p)\nu^*}$. Let ${\tau^*: T \rightarrow \Prob(S_2)}$ satisfy

$$\tau^* \in \Argmax{\rho: T \rightarrow \Prob(S_2)} \min_{\mu' \in \Phi} U(\pi \otimes_\alpha \rho, \mu')$$

Denote ${v^*:= \min_{\mu' \in \Phi} U(\pi \otimes_\alpha \tau^*, \mu')}$. We have

$$U(\pi \otimes_\alpha \tau^*, \xi) = p U(\pi \otimes_\alpha \tau^*, \mu') + (1-p) U(\pi \otimes_\alpha \tau^*, \nu^*)$$

$$U(\pi \otimes_\alpha \tau^*, \xi) \geq pv^* + (1-p) U(\pi \otimes_\alpha \tau^*, \nu^*)$$

Applying Proposition A.6 to the right hand side

$$U(\pi \otimes_\alpha \tau^*, \xi) \geq pv^* + (1-p) (\E_{\pi \times \nu^*}[u_1] + \nu^*(A) \E_{(\pi \otimes_\alpha \tau^*)??? \times \nu^*}[u_2 \mid A])$$

$$U(\pi \otimes_\alpha \tau^*, \xi) \geq pv^* + (1-p) (\E_{(\pi \otimes_\alpha \tau^*) \times \nu^*}[u_1] + \nu^*(A) (\E_{(\pi \otimes_\alpha \tau^*)??? \times \mu}[u_2 \mid A] - (\sup u_2 - \inf u_2)\Dtv(\mu \mid A, \nu^* \mid A)))$$

Also, we have

$$v^* \leq U(\pi \otimes_\alpha \tau^*, \mu)$$
