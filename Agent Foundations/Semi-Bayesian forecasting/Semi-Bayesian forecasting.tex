...
Using the definition of ${\xi}$ and Proposition A.13, we get
...
Now, assume ${x \not\sqsubseteq z}$. Let ${\mu_z \in \Prob(\Obs^+)}$ be as in Proposition A.10. For any ${y \in A_z}$, we have
...
Finally, consider any ${\xi \in \Phi_F}$.

TBD

\subsection{Proof of Proposition 6}

By Propositions A.11 and A.12, ${\Phi_F \in \CC(\ObsO)}$. It remains to show that ${\Phi_F}$ factorizes everywhere.
