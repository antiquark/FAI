...
Fix ${Y,Y'}$ compact Polish spaces. Denote ${X:=Y \times Y'}$ and let ${\pi: X \rightarrow Y}$ be the projection mapping. Define ${Z \subseteq Y \times \T(X) \times \Prob(X)}$ by
...
Consider ${y_k \rightarrow y}$, ${\mu_k \rightarrow \mu}$, ${(y_k, \mu_k) \in \Delta}$. We have ${\E_{\mu_k}[d_{y_k}]=0}$. By Proposition N11, ${d_{y_k} \rightarrow d_y}$, therefore ${\E_\mu[d_y] = 0}$. By Proposition N13, ${\Supp \mu \subseteq y \times Y'}$ and hence ${(y,\mu) \in \Delta}$.
