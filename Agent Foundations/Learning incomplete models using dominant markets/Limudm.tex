...
$$\Prb[S^0_{N_k} - S_0 < -k] \leq \exp(-\frac{k^2}{2 \cdot 2^2 \cdot k})=\exp(-\frac{k}{8})$$

Since ${\sum_k \exp(-\frac{k}{8}) < \infty}$, it holds with probability 1 that there is only a finite number of ${k \in \Nats}$ s.t. ${S^0_{N_k} - S_0 < -k}$.
