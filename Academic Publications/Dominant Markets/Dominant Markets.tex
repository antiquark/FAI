...
Here, $\BM_{:m}$ denotes the projection of $\BM \in \PMO^n$ to $\PMO^m$ and $\BM_m$ denotes the $m$-th component of $\BM$. Define the measurable functions $\SVM G_n: \Ob^{n-1} \times \PMO^n  \rightarrow \Reals$ by
...
Define the measurable functions $\Nr_b G_n: \Ab_b G_n \rightarrow C(\PMO)$ by
