...
Consider a compact Polish metric space $X$, $M \subseteq \PM(X)$ convex and $r_0 > 0$. $\beta \in \Gm(X)$ is said to be \emph{$(M,r_0)$-savvy} when for any $\mu \in \PM(X)$, denoting $r_\mu:=\DKR(\mu,M)$:
