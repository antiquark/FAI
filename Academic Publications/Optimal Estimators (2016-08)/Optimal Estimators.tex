...
${n = 1}$. ${E_{\textsc{NP}} \subseteq \Words}$ is the set of valid programs for ${\mathcal{U}_2}$. ${\mathfrak{F}_{\textsc{NP}}}$ is given by 
...
${n = 1}$. ${E_{\textsc{EXP}} \subseteq \Words}$ is the set of valid programs for ${\mathcal{U}_1}$. ${\mathfrak{F}_{\textsc{EXP}}}$ is given by 
