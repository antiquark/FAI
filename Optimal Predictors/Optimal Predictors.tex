...
%For any $y \in \Supp L_{2\bullet}^K$, $\mu_y^K = (\En_{\Words \times \Words})_*(\mu_1^{K_0} \times \delta_y) \mid (\pi^K)^{-1}(y)$...
...
\[\E_{(x,y) \sim \mu_\pi^K}[\Dtv(\mu_y^K,L_y^K)] \leq \frac{1}{2}\E_{y \sim L_{2\bullet}^K}[\sum_{x \in \Supp L_{1\bullet}^K}\Abs{\mu_y^K(\Chev{x,y})-L_{1\bullet}^K(x)}] \pmod \Fall\]

\[\E_{(x,y) \sim \mu_\pi^K}[\Dtv(\mu_y^K,L_y^K)] \leq \frac{1}{2}\E_{y \sim L_{2\bullet}^K}[\sum_{x \in \Supp L_{1\bullet}^K}\Abs{\frac{\mu_1^{K_0}(x)}{\sum_{x' \in \Words} \mu_1^{K_0}(x') \Prb_{U_\pi^K}[\pi^K(\Chev{x',y})=y]}-L_{1\bullet}^K(x)}] \pmod \Fall\]
