...
Consider $(\mu,f)$ a distributional estimation problem of rank ${n}$, ${P}$ an ${\ESG}$-optimal predictor for ${(\mu,f)}$ and ${\alpha: \Nats^m \Alg \Nats^n}$ an efficient injection. Then, ${P^\alpha}$ is an ${\Fall \alpha^\sharp(\Gamma \alpha)}$-optimal predictor for ${(\mu^\alpha,f)}$.
...
Consider $(\mu,f)$ a distributional estimation problem of rank ${n}$, ${P}$ an ${\EG}$-optimal predictor for ${(\mu,f)}$ and ${\alpha: \Nats^m \Alg \Nats^n}$ an efficient injection. Then, ${P^\alpha}$ is an ${\Fall \alpha(\Gamma \alpha)}$-optimal predictor for ${(\mu^\alpha,f)}$.
