...
\item\label{con:def__pp_reduce__smp} $\Dist$ is $\Fall\alpha(\MGrow \alpha)$-samplable relative to $\pi$.
...
\item\label{con:def__p_reduce__smp} $\Dist$ is $\Fall\alpha(\MGrow \alpha)$-samplable relative to $\pi$.
