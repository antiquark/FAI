...
To see ${\FallU}$ is indeed a fall space, note...

\end{example}
\end{samepage}

The definition of ${\FallU}$ might seem poorly motivated. Its justification lies in the existence theorems proven in Section \ref{sec:e_and_u}.
