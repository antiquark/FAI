...
For this subsection we assume ${n > 0}$. Fix ${r,s: \Nats^n \Alg \Nats}$ s.t.
...
Fix ${l: \Nats^n \rightarrow \Nats^{>0}}$ steadily growing. Denote ${\Gamma_{\textnormal{adv}}^n:=(\Gamma_0^n,\Gamma_l)}$. Fix ${r: \bm{1} \xrightarrow{\Gamma_{\textnormal{adv}}}\Nats}$ steadily growing. Assume ${n > 0}$, ${\GrowR=\Gamma_r}$, ${\GrowA=\Gamma_l}$. Define ${\eta: \Nats^n \rightarrow \Nats^{n-1}}$ by
