...
Fix ${n \in \Nats^{>0}}$. ${\gamma \in \GammaPoly^n}$ is said to be \emph{steadily growing} when it is non-decreasing in the last argument and there is ${q \in \NatPoly{1}}$ s.t.
...
For any ${n \in \Nats^{>0}}$ and ${\gamma^* \in \GammaPoly^n}$ steadily growing, ${\Gamma_{\gamma^*}}$ is a growth space of rank ${n}$. ${\gamma \in \Gamma_{\gamma^*}}$ iff there is ${p \in \NatPoly{1}}$ s.t. ${\gamma(J,k) \leq \gamma^*(J,p(J,k))}$. 
...
\item As functions, ${r, s \in \GammaPoly^n}$.
