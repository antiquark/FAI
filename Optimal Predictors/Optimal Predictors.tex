...
\[\GammaPoly^n := \{\gamma: \NatFun \Nats \mid \exists p \in \NatPoly{1}: \gamma \leq p\}\]
...
\begin{example}
\label{exm:e_uni}
For any ${n \in \Nats^{>0}}$, We define ${\FallU}$, a fall space of rank ${n}$. For any ${\varepsilon: \NatFun \Reals^{\geq 0}}$ bounded, $\varepsilon \in \FallU$ iff there are ${M \in \Reals^{>0}}$ and ${p \in \NatPoly{2}}$ s.t.
...
For any ${p \in \NatPoly{1}}$, define ${\alpha_p: \NatFun \Nats^n}$ by
...
For any ${p \in \NatPoly{1}}$ there are ${\{\omega_p^K \in \mathcal{P}(\Nats)\}_{K \in \Nats^n}}$ s.t. for any ${\zeta: \NatFun \Reals}$ bounded, if 
...
Consider ${h_1, h_2: \NatFun \Nats}$ (not necessarily polynomial), suppose that ${h_1 \leq h_2}$ and there is ${?}$...
%
\end{proof}
