...
% Reformulate this entire subsection: for any family of total functions on words indexed by encodable labels, there is a complete problem for the corresponding samplable class, where each instance of the complete problems consists of K, a label, a sampler and an instance of the problem corresponding to the label

% $\mu_{\mathsf{C}}$ is samplable with less advice than ${\GrowA}$?
