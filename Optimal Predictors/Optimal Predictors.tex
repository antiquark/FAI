...
We review the definition of a one-way function and a non-uniformly hard one-way function and state a theorem by Goldreich and Levin which is used in Section~\ref{sec:fundamentals}.
