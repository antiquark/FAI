...
Fix $\Gamma$ a pair of growth spaces of rank 2 and $\Fall$ a fall space of rank 2. Consider $(\mu,f)$ a distributional estimation problem and $P: \Words \Scheme \Rats$ with bounded range. $P$ is called an \emph{$\Fall^\sharp(\Gamma)$-optimal predictor for $(\mu,f)$} when for any bounded $S: \Words \Scheme \Rats$ with $\R_S \geq \R_P$

\begin{equation}
\label{eqn:op_sharp}
\E_{\mu^k \times U^{\R_P(k,j)} \times U^{\R_S(k,j)-\R_P(k,j)}}[(P^{kj}(x,y) - f(x))S^{kj}(x,yz)] \equiv 0 \pmod \Fall
\end{equation}
...
Consider any bounded $S: \Words \Scheme \Rats$ with $\R_S \geq \R_P$. We have
...
In this case, $G$ is called an \emph{$\Fall(\MGrow)$-generator (resp. $\Fall(\Gamma)$-generator) of $(\mu,f)$ relative to $\pi$}.
...
Denote $\bar{P}_2^{kj}:=P_2^{kj} \circ \pi^{kj}$. For any bounded $S: \Words \Scheme \Rats$ with $\R_S \geq \R_P$ we get
...
$$\E[(\bar{P}_2^{kj}-f_2)f_1 S^{kj}] \equiv \E_{\mu^k \ltimes \pi^{kj} \times U^{\R_{P_2}(k,j)}}[(P_2^{kj}(y,z_{2})-g(y))f_1(x) \E[S^{kj}(x,z_1 z_2 z_3 z_4) \mid \pi^{kj}(x,z_3)=y]] \pmod \Fall$$

$$\E[(\bar{P}_2^{kj}-f_2)f_1 S^{kj}] \equiv \E_{\mu^k \ltimes \pi^{kj}}[\E[(P_2^{kj}(y,z_{2})-g(y))S^{kj}(x,z_1 z_2 z_3 z_4) \mid \pi^{kj}(x,z_3)=y]f_1(x)] \pmod \Fall$$

Let $G$ be an $\Fall(\MGrow)$-generator of $(\mu,f_1)$ relative to $\pi$. Applying Proposition~\ref{prp:gen} to the right hand side we get

$$\E[(\bar{P}_2^{kj}-f_2)f_1 S^{kj}] \equiv \E_{\mu^k \ltimes \pi^{kj}}[\E[(P_2^{kj}(y)-g(y))S^{kj}(G^{kj}(y,w)_1) \mid \pi^{kj}(G^{kj}(y,w)_1,z_{3})=y]G^{kj}(y,w)_2] \pmod \Fall$$

$$\E[(\bar{P}_2^{kj}-f_2)f_1 S^{kj}] \equiv \E_{\mu^k \times U^{\R_S(k,j)} \times \UM_G^{kj}}[(P_2^{kj}(y,z_2)-g(y))S^{kj}(G^{kj}(y,w)_1,z_1 z_2 z_3 z_4) G^{kj}(y,w)_2] \pmod \Fall$$
